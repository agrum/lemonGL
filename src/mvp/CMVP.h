 ...
 *      Author: agrum
 *      Class dealing with Model View projection matrices. Can be used as camera.
 *      To be inherited from QCamera once 4.8 available on repo.
 *      Differ by the possibility to bind a frame buffer on the view.
 */
